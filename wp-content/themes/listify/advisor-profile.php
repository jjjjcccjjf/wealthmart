...
if($advisor_exists != 1):
  ...
  <div class="container">
    <section class="listing-banner" style="background: url(<?php echo theme_url; ?>images/bannerimg.jpg) no-repeat center center; background-size: cover;">
      <aside>
        <h1><?php echo $advisor_info->display_name; ?> <span>Verified <i class="fa fa-check" aria-hidden="true"></i></span></h1>
        <h4>Quezon City</h4>
        <h4>NCR</h4>
        <p><?php if($advisor_details){ echo $advisor_details['expertise']; } ?></p>
