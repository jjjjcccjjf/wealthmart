...
if(isset($_POST['apt_dt'])){
  ...
  $price = 100; # $_POST['apt_price'];
  $place = "Appointment at somewhere?";

  $post_id = wp_insert_post( array(
    'post_title' => 'Regular Consultation with ' . $_POST['apt_aname']  # apt_aname    appointed adivsor name
    . " at " . $apt_date, # apt_dt    appointment datetime
    'post_content' => "One time appointment scheduled at $apt_datetime.",
    'post_status' => 'publish',
    'post_type' => "product",
  ) );
